...
//Disable transmitter and receiver until proper settings are chosen for the UART module
  UART0_C2|=(0<<UART_C2_TE_SHIFT); //Field 3 is Transmitter Enable
	UART0_C2|=(0<<UART_C2_RE_SHIFT); //Field 2 is Receiver Enable
	UART3_C2|=(0<<UART_C2_TE_SHIFT);
	UART3_C2|=(0<<UART_C2_RE_SHIFT);
